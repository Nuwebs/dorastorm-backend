...
<head>
    ...
    <title>@lang('emails.quotations.title')</title>
    <style type="text/css">
        body,
        table,
        td {
        ...
        <tbody>
            <tr>
                <td valign="top" style="line-height: 24px; font-size: 16px; margin: 0;" align="left">
                    <table class="container d-flex justify-content-center p-4" role="presentation" border="0"
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;"
                                                                                    align="left">
                                                                                    <h5 class="card-title"
                                                                                        style="padding-top: 0; padding-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 20px; line-height: 24px; margin: 0;"
                                                                                        align="left">@lang('emails.quotations.notification.content_title')
                                                                                    </h5>
                                                                                    <p class="card-text"
                                                                                        style="line-height: 24px; font-size: 16px; width: 100%; margin: 0;"
                                                                                        align="left">@lang('emails.quotations.notification.content')
                                                                                    </p>
                                                                                </td>
                                                                            </tr>
                                                                        </tbody>
